...
const initialState = {
  resumeDetails: localStorage.getItem("resumeDetails")
    ...
    : {
        ...
        facts: ["", ""],
        skills: localStorage.getItem("") ? JSON.parse(localStorage.getItem("")) : [{}],
  ...
  choosenResume: {
    choosenResume: localStorage.getItem("choosenResume") ? JSON.parse(localStorage.getItem("choosenResume")) : "",
  },
  // userSignin: {
